...
def newfeats(df):
    ...
    df = df.dropna(subset=['lat', 'piscina', 'metroscubiertos', 'metrostotales', 'habitaciones', 'escuelascercanas', 'centroscomercialescercanos'])
    ...
    df['metros'] = df['metroscubiertos'] / df['metrostotales']
